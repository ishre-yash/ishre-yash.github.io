...
import { CircleCheckBigIcon, MenuIcon, SettingsIcon, MoonIcon, SunIcon, MonitorIcon, CircleIcon, Volume1Icon, VolumeXIcon, ImageIcon, GithubIcon, LinkIcon, TwitterIcon, HomeIcon, ClockIcon, CopyIcon } from "lucide-react";
import { Button } from "@/components/ui/button"

const NavLinkStyles = "flex cursor-pointer items-center px-4 py-3 text-sm font-medium tracking-wide hover:bg-secondary hover:text-primary"
...
function MainMenu() {
    ...
    return (
        <div className="relative inline-block text-left">
            ...
            {openMenu && <div className="fixed inset-0 z-0" onClick={() => setOpenMenu(!openMenu)} />}

            <div
                className={`transition ease-in-out z-10  ${openMenu
...
function SettingsMenu() {
    ...
    return (
        <section className="relative inline-block text-left">
            <Button variant="outline" className="z-0" onClick={() => setSettings(!settings)}>
