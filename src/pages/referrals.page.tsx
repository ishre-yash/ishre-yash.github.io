      ...
      <ul className="space-y-8 max-w-2xl w-full">
        {
          ReferralsData.map((d, idx) => (
            <li className="rounded-lg border bg-background/20 backdrop-blur transition duration-300 ease-in-out" key={idx}>
                ...
                <div className="m-2 mt-0">
                  <div
                    className={cn(
                      ...
                      "w-full backdrop-blur bg-background/30 border gap-2"
                    )}
                  >
                    <AwardIcon size={16} />
                    {d.bonus}
